...
export default function ArticleForm(props) {
  ...
  useEffect(() => {
    // ✨ implement
    if (currentArticle)  {setValues({ title: currentArticle.title, text: currentArticle.text, topic: currentArticle.topic }
  ...
  return (
    ...
    <form id="form" onSubmit={onSubmit}>
      ...
      <div className="button-group">
        <button onClick={onSubmit} disabled={isDisabled()} id="submitArticle">Submit</button>
